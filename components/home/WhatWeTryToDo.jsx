...
export default function WhatWeTryToDo() {
  return (
    <section className="what-we-try-to-do">
      {" "}
      <div className="what-we-try-to-do-rectangle"></div>
      ...
      <div className="what-we-try-to-do-content">
        ...
        <h2>Napredak djece očekujte u ovim poljima:</h2>{" "}
        <p>
          Djeca će učiti o različitim kulturama, zemljama, povijesti i mnogim
          drugim temama.
        </p>
